...
def split_train_val_test(directory, train_size, val_size, test_size):
        ...
        if os.path.exists(os.path.join(directory, species_folder)):
            if (species_folder != "train") and (species_folder != "val") and (species_folder != "test"):
                ...
                for file in val_files:
                    ...
                    os.rename(os.path.join(directory, species_folder, file), os.path.join(val_dir, species_folder, file))
...
if __name__ == "__main__":
    ...
    split_train_val_test(dest_path, train_size, val_size, test_size)
